...
drop database db_travel_agency
...
create table trips(
 ...
 values(service_code, service_name, servive_description,service_score,service_commercial)
       (        2001,  'personnel', 'gere le personnel',         1524,       ' achat'   ),
 ...
 values( city_code , city_name ),
	...
	insert into table themes
	values( theme_code , theme_name , theme_description)
	      (        4001, 'excursion',        ' marche' ),
...
inset into sales_people
values( client_id , client_name, client_fisrtname, client email, client_phone, client_added , client_password)
      (      5001 , 'robert'   ,        ' Michel','12@hotmail.fr','012345678' ,'12/02/2021' ,        'wqse ' )
